...
import { Code, Settings, Play, Eye, ArrowRight, CornerRightDown } from 'lucide-react';
...
const steps = [
  {
    ...
    description: 'Explore highly optimized implementation codes of common algorithms. The code is read-only, ensuring you focus on studying structure and correctness.',
  },
  {
    index: '02',
    ...
    description: 'Choose from predefined standard test cases, or create temporary ones in-session. Feed custom parameters directly into the execution engine.',
  },
  {
    index: '03',
    ...
    description: 'Use the playback console to go forward, backward, or auto-play. Watch the executing code-line highlight exactly as the engine resolves statements.',
  },
  {
    index: '04',
    ...
    description: 'Watch variables, arrays, nodes, pointers, or dynamic programming grids animate dynamically in response to the current code trace step.',
  },
];
...
export default function LearningFlow() {
  ...
  return (
    <section id="learning-flow" className="py-20 px-6 md:px-12 bg-[#FCF9F3] border-t border-[#ebdcb9]/40 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-2xl mb-16">
          ...
          <p className="font-sans font-medium text-sm md:text-base text-zinc-500 mt-4 leading-relaxed">
            By mapping static implementation structures directly to dynamic memory transitions, we build a spatial mental model of algorithm execution.
          </p>
        </div>
            ...
            {steps.map((step, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className={`cursor-pointer border-3 rounded-2xl p-5 md:p-6 transition-all duration-300 flex items-start gap-4 shadow-sm
                    ${isActive 
                      ? `${step.color} border-zinc-950 translate-x-2 shadow-[4px_4px_0px_rgba(18,18,20,1)]` 
                      : 'border-zinc-200 bg-white hover:border-zinc-400'
                    }`}
                >
                  <div className={`p-2.5 rounded-xl border-2 border-zinc-950 font-bold shrink-0 transition-all duration-300
          ...
          <div className="lg:col-span-7 bg-zinc-950 rounded-3xl p-4 md:p-6 border-3 border-zinc-900 shadow-[8px_8px_0px_rgba(18,18,20,1)] text-white w-full select-none">
            ...
            <div className="flex items-center justify-between border-b border-zinc-800 pb-4 mb-4 font-mono text-xs text-zinc-400">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold tracking-wider text-[10px]">DSA_SANDBOX_CONSOLE</span>
              </div>
              <div className="flex gap-2">
                <span className="px-2 py-0.5 rounded bg-zinc-800 text-[9px] font-bold">LANGUAGE: C++</span>
                <span className="px-2 py-0.5 rounded bg-indigo-900 text-indigo-200 text-[9px] font-bold">ACTIVE STEP: {activeStep + 1}/4</span>
              </div>
            </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-3.5 rounded-xl border border-indigo-500/30 bg-indigo-950/20">
                        <div className="text-xs font-bold text-indigo-400 font-space mb-1">Predefined Cases</div>
                        <div className="text-[11px] text-zinc-400 font-sans mb-3">Quick pre-configured parameters.</div>
                        <div className="flex flex-col gap-1.5">
                          <div className="text-[10px] font-mono bg-zinc-800 p-1.5 rounded flex justify-between border border-zinc-700">
                            ...
                            <span className="text-indigo-400 font-bold">[5, 4, 3, 2, 1]</span>
                          </div>
                          <div className="text-[10px] font-mono bg-zinc-800 p-1.5 rounded flex justify-between">
                            <span>Case 2 (Sorted)</span>
                            <span className="text-zinc-500">[1, 2, 3, 4, 5]</span>
                          </div>
                        </div>
                      </div>
                      
                      <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-900/50">
                        <div className="text-xs font-bold text-zinc-300 font-space mb-1">Custom Parameters</div>
                        <div className="text-[11px] text-zinc-500 font-sans mb-3">Inject custom arrays temporarily.</div>
                        <div className="flex gap-2">
                          <input 
                            readOnly
                            type="text" 
                ...
                {activeStep === 3 && (
                  ...
                  >
                    ...
                    <div className="bg-zinc-800/50 p-2.5 rounded-xl border border-zinc-800 font-mono text-[10px] text-zinc-400 text-center">
                      Memory variables: <span className="text-amber-300">comparing = [1, 2]</span> | <span className="text-emerald-400">swapped = true</span>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
