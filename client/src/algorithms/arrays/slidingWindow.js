...
function generateSteps(input) {
  ...
  steps.push({
    ...
    line: { cpp: 2, python: 2 },
    state: { array: [...arr], windowStart: 0, windowEnd: -1, windowSum: 0, bestSum: 0, k },
    variables: { windowSum: 0, k },
    affected: [],
  ...
  for (let i = 0; i < k; i++) {
    ...
    steps.push({
      ...
      line: { cpp: 6, python: 6 },
      state: { array: [...arr], windowStart: 0, windowEnd: i, windowSum, bestSum: 0, k },
  ...
  steps.push({
    ...
    line: { cpp: 9, python: 8 },
    state: { array: [...arr], windowStart: 0, windowEnd: k - 1, windowSum, bestSum, k },
    variables: { windowSum, bestSum },
  ...
  for (let right = k; right < arr.length; right++) {
    ...
    steps.push({
      ...
      state: { array: [...arr], windowStart: leaving, windowEnd: right, windowSum, bestSum, k, entering: right },
      variables: { right, windowSum },
      affected: [right],
    ...
    steps.push({
      ...
      state: { array: [...arr], windowStart: leaving + 1, windowEnd: right, windowSum, bestSum, k, leaving },
      variables: { right, windowSum },
      affected: [leaving],
    ...
    if (windowSum > bestSum) {
      ...
      steps.push({
        ...
        state: { array: [...arr], windowStart: leaving + 1, windowEnd: right, windowSum, bestSum, k },
        variables: { windowSum, bestSum },
        affected: Array.from({ length: k }, (_, i) => leaving + 1 + i),
  ...
  steps.push({
    ...
    line: { cpp: 18, python: 16 },
    state: { array: [...arr], windowSum, bestSum, k, result: bestSum },
    variables: { bestSum },
    affected: [],
...
const lineMap = {
  cpp: { initialize: 2, add_to_window: 6, calculate: 9, remove_from_window: 13, update_best: 15, complete: 18 },
  python: { initialize: 2, add_to_window: 6, calculate: 8, remove_from_window: 12, update_best: 14, complete: 16 },
};
...
export const slidingWindow = {
  ...
  testCases: [
    { id: "sliding-1", name: "Example 1", input: { arr: [2, 4, 1, 7, 3, 6], k: 3 }, expectedOutput: 16 },
    { id: "sliding-2", name: "Example 2", input: { arr: [1, 2, 3, 4, 5], k: 2 }, expectedOutput: 9 },
  ],
